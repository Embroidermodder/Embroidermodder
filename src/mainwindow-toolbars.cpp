...
void MainWindow::createTextToolbar()
{
    ...
    actionHash.value("textbold")->setChecked(getSettingsTextStyleBold());
    toolbarText->addAction(actionHash.value("textitalic"));
    actionHash.value("textitalic")->setChecked(getSettingsTextStyleItalic());
    toolbarText->addAction(actionHash.value("textunderline"));
    actionHash.value("textunderline")->setChecked(getSettingsTextStyleUnderline());
    toolbarText->addAction(actionHash.value("textstrikeout"));
    actionHash.value("textstrikeout")->setChecked(getSettingsTextStyleStrikeOut());
    toolbarText->addAction(actionHash.value("textoverline"));
    actionHash.value("textoverline")->setChecked(getSettingsTextStyleOverline());
