...
Command command_ptrs[N_ACTIONS] = {
    do_nothing_command,
    do_nothing_command,
    new_command,
    open_command,
    ...
    paste_command,
    paste_selected_command,
    undo_command,
    redo_command,
    window_close_command,
    window_close_all_command,
    window_cascade_command,
    window_tile_command,
    window_next_command,
    window_previous_command,
    help_command,
    changelog_command,
    tip_of_the_day_command,
    about_command,
    whats_this_command,
    icon16_command,
    icon24_command,
    ...
    icon128_command,
    settings_command,
    make_layer_active_command,
    layers_command,
    layer_selector_command,
    layer_previous_command,
    color_selector_command,
    line_type_selector_command,
    line_weight_selector_command,
    hide_all_layers_command,
    show_all_layers_command,
    freeze_all_layers_command,
    thaw_all_layers_command,
    lock_all_layers_command,
    unlock_all_layers_command,
    text_bold_command,
    text_italic_command,
    text_underline_command,
    text_strikeout_command,
    text_overline_command,
    zoom_real_time_command,
    zoom_previous_command,
    zoom_window_command,
    zoom_dynamic_command,
    zoom_scale_command,
    zoom_center_command,
    zoom_in_command,
    zoom_out_command,
    zoom_selected_command,
    zoom_all_command,
    ...
    heart_command,
    line_command,
    located_point_command,
    mirror_selected_command,
    move_command,
    move_selected_command,
    path_command,
    platform_command,
    point_command,
    polygon_command,
    ...
    do_nothing_command,
    scale_command,
    scale_selected_command,
    select_all_command,
    single_line_text_command,
    snowflake_command,
    star_command,
    syswindows_command,
    todo_command,
