...
PolygonObject::PolygonObject(qreal x, qreal y, const QPainterPath& p, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void PolygonObject::init(qreal x, qreal y, const QPainterPath& p, unsigned int rgb, Qt::PenStyle lineType)
{
