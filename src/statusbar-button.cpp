...
void StatusBarButton::contextMenuEvent(QContextMenuEvent *event)
{
    ...
    {
        QAction* settingsSnapAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "gridsnapsettings" + ".png"), "&Settings...", &menu);
    ...
    {
        QAction* settingsGridAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "gridsettings" + ".png"), "&Settings...", &menu);
    ...
    {
        QAction* settingsRulerAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "rulersettings" + ".png"), "&Settings...", &menu);
    ...
    {
        QAction* settingsOrthoAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "orthosettings" + ".png"), "&Settings...", &menu);
    ...
    {
        QAction* settingsPolarAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "polarsettings" + ".png"), "&Settings...", &menu);
    ...
    {
        QAction* settingsQSnapAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "qsnapsettings" + ".png"), "&Settings...", &menu);
    ...
    {
        QAction* settingsQTrackAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "qtracksettings" + ".png"), "&Settings...", &menu);
    ...
    else if(objectName() == "StatusBarButtonLWT")
    {
        ...
        if(gview)
        {
            QAction* enableRealAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "realrender" + ".png"), "&RealRender On", &menu);
            ...
            QAction* disableRealAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "realrender" + ".png"), "&RealRender Off", &menu);
        ...
        QAction* settingsLwtAction = new QAction(QIcon("icons/" + getSettingsGeneralIconTheme() + "/" + "lineweightsettings" + ".png"), "&Settings...", &menu);
