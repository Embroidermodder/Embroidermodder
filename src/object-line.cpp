...
LineObject::LineObject(qreal x1, qreal y1, qreal x2, qreal y2, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void LineObject::init(qreal x1, qreal y1, qreal x2, qreal y2, unsigned int rgb, Qt::PenStyle lineType)
{
