...
TextSingleObject::TextSingleObject(const QString& str, qreal x, qreal y, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void TextSingleObject::init(const QString& str, qreal x, qreal y, unsigned int rgb, Qt::PenStyle lineType)
{
