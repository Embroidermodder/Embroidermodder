...
ImageObject::ImageObject(qreal x, qreal y, qreal w, qreal h, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void ImageObject::init(qreal x, qreal y, qreal w, qreal h, unsigned int rgb, Qt::PenStyle lineType)
{
