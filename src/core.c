...
ActionData action_table[MAX_ACTIONS] = {
    ...
    },
    {
        ...
        toolbar = "Draw",
        */
        .id = ACTION_ADD_HORIZONTAL_DIMENSION, /* 6 */
        .icon = "ellipse",
        .command = "ellipse",
        .tooltip = "Ellipse",
        .statustip = "Creates a ellipse: ELLIPSE",
    ...
    },
    {
        ...
        toolbar = "Draw",
        */
        .id = ACTION_ADD_REGULAR_POLYGON, /* 16 */
        .icon = "rectangle",
        .command = "rectangle",
        .tooltip = "&Rectangle",
        .statustip = "Creates a rectangular polyline: RECTANGLE.",
    ...
    },
    {
        ...
        toolbar = "Draw",
        */
        .id = ACTION_ADD_ROUNDED_RECTANGLE, /* 17 */
        .icon = "rectangle",
        .command = "rectangle",
        .tooltip = "&Rectangle",
        .statustip = "Creates a rectangular polyline: RECTANGLE.",
    ...
    },
    {
        ...
        toolbar = "Draw",
        */
        .id = ACTION_ADD_VERTICAL_DIMENSION, /* 24 */
        .icon = "rectangle",
        .command = "rectangle",
        .tooltip = "&Rectangle",
        .statustip = "Creates a rectangular polyline: RECTANGLE.",
    ...
    },
    {
        ...
        toolbar = "Draw",
        */
        .id = ACTION_CALCULATE_DISTANCE, /* 29 */
        .icon = "warning",
        .command = "alert",
        .tooltip = "&Alert",
        .statustip = "Alert user of an issue.",
    ...
    {
        .id = ACTION_PERPENDICULAR_DISTANCE, /* 59 */
        .icon = "paste",
        .command = "paste",
        .tooltip = "&Paste",
        .statustip = "Paste the clipboard's contents into the current selection.",
    ...
    {
        .id = ACTION_SET_BACKGROUND_COLOR, /* 74 */
        .icon = "settingsdialog",
        .command = "settingsdialog",
        .tooltip = "&Settings",
        .statustip = "Configure settings specific to this product.",
    ...
    {
        .id = ACTION_SET_CROSSHAIR_COLOR, /* 75 */
        .icon = "settingsdialog",
        .command = "settingsdialog",
        .tooltip = "&Settings",
        .statustip = "Configure settings specific to this product.",
    ...
    {
        .id = ACTION_SET_PROMPT_PREFIX, /* 78 */
        .icon = "settingsdialog",
        .command = "settingsdialog",
        .tooltip = "&Settings",
        .statustip = "Configure settings specific to this product.",
    ...
    {
        .id = ACTION_SET_RUBBER_FILTER, /* 79 */
        .icon = "settingsdialog",
        .command = "settingsdialog",
        .tooltip = "&Settings",
        .statustip = "Configure settings specific to this product.",
    ...
    {
        .id = ACTION_MAKE_LAYER_CURRENT, /* 101 */
    ...
    {
        .id = ACTION_LINE_TYPE_SELECTOR, /* 132 */
    ...
    {
        .id = ACTION_LINE_WEIGHT_SELECTOR, /* 133 */
    ...
    },
    {
        ...
        toolbar = "Draw",
        */
        .id = ACTION_ADD_SINGLE_LINE_TEXT, /* 140 */
        .icon = "heart",
        .command = "heart",
        .tooltip = "&Heart",
        .statustip = "Creates a heart: HEART",
    ...
    {
        .id = ACTION_FREEZE_ALL_LAYERS, /* 142 */
    ...
    {
        .id = ACTION_UNLOCK_ALL_LAYERS, /* 145 */
    ...
    },
    {
        ...
        toolbar = "Draw",
        */
        .id = ACTION_SINGLE_LINE_TEXT, /* 161 */
