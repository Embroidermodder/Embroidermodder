...
EllipseObject::EllipseObject(qreal centerX, qreal centerY, qreal width, qreal height, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void EllipseObject::init(qreal centerX, qreal centerY, qreal width, qreal height, unsigned int rgb, Qt::PenStyle lineType)
{
