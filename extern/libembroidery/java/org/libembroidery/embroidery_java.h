...
#ifndef __EMBROIDERY_JAVA_H__
#define __EMBROIDERY_JAVA_H__
...
double c_embEllipse_diameterX(EmbEllipse ellipse);
double c_embEllipse_diameterY(EmbEllipse ellipse);
double c_embEllipse_width(EmbEllipse ellipse);
double c_embEllipse_height(EmbEllipse ellipse);
...
void c_embPattern_correctForMaxStitchLength(int p, double maxStitchLength, double maxJumpLength);
