...
\item[\mbox{\hyperlink{todo__todo000013}{Todo}}]convert this to update and make it Type sensitive. \end{DoxyRefDesc}
...
\end{DoxyWarning}
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000012}{Todo}}]set the justification properly. 
