\hypertarget{geometry-and-algorithms_basic-features}{}\doxysubsection{Basic Features}\label{geometry-and-algorithms_basic-features}
...
In all cases, open Embroidermodder 2 and use {\ttfamily File $>$ Open} to get the open file dialog.
