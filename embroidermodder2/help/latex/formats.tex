...
\item[\mbox{\hyperlink{todo__todo000187}{Todo}}]Josh, Review this section and move any info still valid or needing work into TODO comments in the actual libembroidery code. Many items in this list are out of date and do not reflect the current status of libembroidery. When finished, delete this file.\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000188}{Todo}}]Support for Singer FHE, CHE (Compucon) formats?\end{DoxyRefDesc}
