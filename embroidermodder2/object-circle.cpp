...
CircleObject::CircleObject(qreal centerX, qreal centerY, qreal radius, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void CircleObject::init(qreal centerX, qreal centerY, qreal radius, unsigned int rgb, Qt::PenStyle lineType)
{
