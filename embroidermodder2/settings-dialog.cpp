...
QWidget* Settings_Dialog::createTabGeneral()
{
    ...
    QString s = "icons/" + dialog_general_icon_theme.string_value + "/icon16.png";
...
QWidget* Settings_Dialog::createTabOpenSave()
{
    ...
    for (std::vector<QString>::size_type i=0; i<extensions.size(); i++) {
...
{
    comboBox->addItem(mainWin->load_icon("colorred"),     tr("Red"),     qRgb(255,  0,  0));
    comboBox->addItem(mainWin->load_icon("coloryellow"),  tr("Yellow"),  qRgb(255,255,  0));
    comboBox->addItem(mainWin->load_icon("colorgreen"),   tr("Green"),   qRgb(  0,255,  0));
    comboBox->addItem(mainWin->load_icon("colorcyan"),    tr("Cyan"),    qRgb(  0,255,255));
    comboBox->addItem(mainWin->load_icon("colorblue"),    tr("Blue"),    qRgb(  0,  0,255));
    comboBox->addItem(mainWin->load_icon("colormagenta"), tr("Magenta"), qRgb(255,  0,255));
    comboBox->addItem(mainWin->load_icon("colorwhite"),   tr("White"),   qRgb(255,255,255));
