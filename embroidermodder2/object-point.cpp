...
PointObject::PointObject(qreal x, qreal y, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void PointObject::init(qreal x, qreal y, unsigned int rgb, Qt::PenStyle lineType)
{
