...
ArcObject::ArcObject(qreal startX, qreal startY, qreal midX, qreal midY, qreal endX, qreal endY, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void ArcObject::init(qreal startX, qreal startY, qreal midX, qreal midY, qreal endX, qreal endY, unsigned int rgb, Qt::PenStyle lineType)
{
...
void ArcObject::calculateArcData(qreal startX, qreal startY, qreal midX, qreal midY, qreal endX, qreal endY)
{
    ...
    qreal radius = QLineF(center.x, center.y, arc.mid.x, arc.mid.y).length();
