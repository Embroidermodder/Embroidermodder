...
RectObject::RectObject(qreal x, qreal y, qreal w, qreal h, unsigned int rgb, QGraphicsItem* parent) : BaseObject(parent)
{
...
void RectObject::init(qreal x, qreal y, qreal w, qreal h, unsigned int rgb, Qt::PenStyle lineType)
{
