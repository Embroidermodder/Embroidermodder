...
void
day_click(float x, float y)
{
    mainWin()->dayVision();
    //endCommand();
}

void day_context(std::string str)
{
    mainWin()->dayVision();
    //endCommand();
}

void day_prompt(std::string str)
{
    mainWin()->dayVision();
    //endCommand();
}
...
void new_click(float x, float y)
{
    newFile();
    endCommand();
}

void new_context(std::string str)
{
    newFile();
    endCommand();
}

void new_prompt(std::string str)
{
    newFile();
    endCommand();
}
...
void zoom_out_click(float x, float y)
{
    zoomOut();
    endCommand();
}

void zoom_out_context(std::string str)
{
    zoomOut();
    endCommand();
}

void zoom_out_prompt(std::string str)
{
    zoomOut();
    endCommand();
}
...
void help_click(float x, float y)
{
    help();
    endCommand();
}

void help_context(std::string str)
{
    help();
    endCommand();
}

void help_prompt(std::string str)
{
    help();
    endCommand();
}
