...
"""
=====================================
|module_summary| KeyboardShortcuts.py
=====================================

Default Keyboard Shortcuts for Embroidermodder 2.
"""
...
WhatsThisContextHelpShortcut =      ''                       #:
                                                             #:
# Layer
MakeLayerActiveShortcut =           ''                       #:
LayersShortcut =                    ''                       #:
LayerPreviousShortcut =             ''                       #:
                                                             #:
# Text
TextBoldShortcut =                  ''                       #:
TextItalicShortcut =                ''                       #:
TextUnderlineShortcut =             ''                       #:
TextStrikeOutShortcut =             ''                       #:
TextOverlineShortcut =              ''                       #:
