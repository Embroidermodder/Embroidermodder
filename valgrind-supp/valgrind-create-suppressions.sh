...
# 1) valgrind --leak-check=full --show-reachable=yes --error-limit=no --suppressions=./valgrind-qt.supp --suppressions=./valgrind-misc.supp --gen-suppressions=all --log-file=memleak.txt ../embroidermodder2/./embroidermodder2
# 2) cat ./memleak.txt | ./valgrind-create-suppressions.sh > memleak.supp
####################################################################################################################################################################################
